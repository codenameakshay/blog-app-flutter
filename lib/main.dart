...
void main() =>
    runApp(MaterialApp(theme: ThemeData.dark(), home: WikipediaExplorer()));
...
class _WikipediaExplorerState extends State<WikipediaExplorer> {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: const Text("CNAkshay's Blog"),
        ...
        body: WebView(
          initialUrl: 'https://blog-bd6w.onrender.com/',
        ...
        return PopupMenuButton<String>(
          onSelected: (String value) async {
            if (value == 'Email link') {
              var url = await controller.data.currentUrl();
              await launch(
                  'mailto:?subject=Check out this cool website&body=$url');
            } else {
